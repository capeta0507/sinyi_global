...
/* harmony import */ var _components_fastButton__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/fastButton */ "./components/fastButton.js");
...
const MainContain = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 100%;
  padding: 150px 0 50px 0;
  background: #fff;
`;
const MainDescription = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 100%;
...
`;
const ListContent = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 60%;
  margin: 0 auto;
  @media (max-width: 768px){
    width: 100%;
...
`;
const ConTitle = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
...
`;
const ConText = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  color: #5A5A5A;
  font-size: 18px;
  padding: 10px 15px;
  margin-top: 11px;
...
`;
const ConList = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  color: #5A5A5A
  font-size: 18px;
  display: flex;
`;
const Dolt = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 6px;
  height: 6px;
  background: #00B1FF;
  border-radius: 50%;
...
`;
const Account = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 100%;
  margin: 0 auto;
  color: #5A5A5A;
  font-size: 14px;
...
`;
const IptControl = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 70%;
  margin: 5px 0;
  padding-left: 10px;
  padding-right: 10px;
...
const Button = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  ...
  border-radius: 5px;
`;
const ItpBlock = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
...
`;
const ExTex = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div`
  width: 85%;
  padding-left: 11px;
  padding-right: 9px;
  @media (max-width: 768px){
...
const Bid = () => {
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: undefined
  }, "\u9001\u51FA"))))), __jsx(_components_fastButton__WEBPACK_IMPORTED_MODULE_6__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 361
    },
...
module.exports = __webpack_require__(/*! C:\Users\xj654\Desktop\專案\sinyi_global\pages\bid.js */"./pages/bid.js");
